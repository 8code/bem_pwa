...
<div class="flex flex-wrap pb-40 ">
    ...
    <section class="w-full p-2 relative">
              <div class="flex pb-5 items-start ">
                  <img width="50px" :src="$store.state.user.avatar" alt="avatar" class="rounded-full">
      ...
      <router-link to="/new/group" class="w-full bg-theme_primary p-5 m-2 rounded-xl flex">
      ...
      <button @click="$store.commit('logout')" class="w-full bg-theme_primary py-3 text-danger m-2 rounded-xl flex justify-center">
        Keluar
      </button>                 
