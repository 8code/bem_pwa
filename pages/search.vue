<template>
 ...
 <div class="mx-auto text-sm flex content-center justify-center text-center p-4">
    <router-link to="/" class="bg-theme_primary_dark text-primary hover:bg-primary hover:text-white hover:border-0 mx-1 w-1/2 px-10 py-2  rounded-full font-bold"> {{ $t("Home")}} </router-link>
    <router-link to="/search" class="mx-1 w-1/2 px-10 py-2  bg-primary text-white rounded-full font-bold">
    {{ $t("search")}} 
    </router-link>
</div>
