  ...
  <div :class="settings" style="min-height:100vh">
    ...
    >
      <main
        ...
        :style="$route.path.includes('quest/') || $route.path.includes('msg') || $route.path.includes('finder') || $route.path.includes('find/') ? 'max-width:1100px' : `max-width:600px`"
      >
          <Nuxt class="w-full" />
      </main>
      ...
      <nav class="fixed bottom-0 flex lg:hidden w-full bg-theme_primary  ">
        ...
        <path d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2zm.995-14.901a1 1 0 1 0-1.99 0A5.002 5.002 0 0 0 3 6c0 1.098-.5 6-2 7h14c-1.5-1-2-5.902-2-7 0-2.42-1.72-4.44-4.005-4.901z"/>
          ...
          <nuxt-link
            :to="localePath('/msg')"
            :class="$route.path.includes('msg') ? tactiveClass : tnonActiveClass"
          >

          <svg v-if="$route.path.includes('msg')" width="1em" height="1em"  viewBox="0 0 16 16" class="bi bi-chat-text-fill text-primary" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <span
              :class="$route.path.includes('/msg') ? activeClass : nonActiveClass"
            >
              {{ $t("messages") }}
            </span>
          </nuxt-link>
