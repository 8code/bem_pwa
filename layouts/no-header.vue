    ...
    >
      ...
      <nav class="fixed bottom-0 flex lg:hidden w-full bg-theme_primary  ">
        <div class="flex w-full text-primary font-bold ">
          ...
          <nuxt-link
            to="/channels"
            :class="$route.path.includes('/channels') ? tactiveClass : tnonActiveClass"
          >

          <svg v-if="$route.path.includes('channels')" width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-chat-dots-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <nav class="hidden left-0 fixed pb-3 lg:flex h-screen ml-10 w-64 text-lg">
        ...
        >
          ...
          <nuxt-link
            ...
            class="w-full rounded-full flex px-1 py-2 mx-1 my-1 to-hover hover:text-primary"
          >
           <svg v-if="$route.path.includes('channels')" width="1.5em" height="1.5em" viewBox="0 0 16 16" class="text-primary bi bi-chat-dots-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" d="M16 8c0 3.866-3.582 7-8 7a9.06 9.06 0 0 1-2.347-.306c-.584.296-1.925.864-4.181 1.234-.2.032-.352-.176-.273-.362.354-.836.674-1.95.77-2.966C.744 11.37 0 9.76 0 8c0-3.866 3.582-7 8-7s8 3.134 8 7zM5 8a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm4 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm3 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"/>
          </svg>
