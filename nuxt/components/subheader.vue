...
<div class="mb-10 w-full">
    <div class="text-sm flex fixed top-0 z-10 bg-theme_primary w-full mx-auto pt-2 px-3"
       ...
       >
            ...
            {{ $t("Explore") }}
             ...
             <nuxt-link v-if="name !== 'groups'" :to="localePath('/msg')" class=" mx-1 ml-auto py-2 font-bold mt-1">
              ...
              <nuxt-link v-else :to="localePath('/new/group')" class=" mx-1 ml-auto py-2 font-bold mt-1">
               <svg
        width="1.5em"
        height="1.5em"
        viewBox="0 0 16 16"
