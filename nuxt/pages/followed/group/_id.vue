...
export default {
  ...
  methods: {
    getData(){
        ...
        this.$axios.$get("/users?member_group="+this.$route.params.id+"&type="+this.filter.type+"&search="+this.filter.search+"&page="+this.filter.page).then(res => {
          this.data = res
        });
    },
    async loadMoregetData($state){
        ...
        await this.$axios.$get("/users?member_group="+this.$route.params.id+"&type="+this.filter.type+"&search="+this.filter.search+"&page="+this.filter.page)
        .then(res => {
